...
#pragma warning(disable: 6294)  //循环条件错误
#pragma warning(disable: 26495) //类成员变量未初始化
#pragma warning(disable: 26498) //const 变量未初始化
#pragma warning(disable: 26800) //协程中指针生命周期管理不当

#include <spdlog/spdlog.h>		// spdlog 库
#include <spdlog/fmt/ostr.h>	//输出流操作符
#pragma warning(pop)			// 恢复原始警告状态
